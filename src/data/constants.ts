...
using use = useUsing("use")`,
  ...
  [SkillNames.VUE]: {
    ...
    label: "Python",
    shortDescription:
      "elegant, powerful, and making data dance since '91! 🐍✨",
    color: "#3776ab",
  ...
  [SkillNames.WORDPRESS]: {
    ...
    name: "wordpress",
    label: "Java",
    shortDescription: "write once, run anywhere, been flexing since '95! ☕💪",
    color: "#007396",
  ...
  [SkillNames.NGINX]: {
    ...
    name: "nginx",
    label: "Postman",
    shortDescription: "API testing made easy, delivering requests with style! 📮🚀",
    color: "#ff6c37",
